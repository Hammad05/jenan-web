...
export default function LegalTranslation() {
    return <div className="mx-20">
        ...
        <p className="text-xl font-ibm-plex-sans-400">At Jenan Documents Clearing Company Dubai, we offer a comprehensive range of translation services to clients worldwide at competitive rates. Each document is translated by a specialist with linguistic expertise in the source and target languages, maintaining the accuracy and nuance of the translation process.
            With a dedicated team of experts, our translation services in Dubai provide precise and specialised translations across a diverse spectrum of industries, including medical, technical, and legal translations. We provide legal translation services in over 100 languages and dialects and serve all document types</p>
    </div>;
}