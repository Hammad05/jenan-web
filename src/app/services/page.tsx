  ...
  return (
    <React.Fragment>
      <div className="px-[var(--layout-padding-md)] md:px-0 ">
        <h1 className="text-xl font-ibm-plex-sans-500 md:text-3xl md:font-ibm-plex-sans-400 mb-1">
          Welcom to Jenan{" "}
        </h1>
        <div className="font-ibm-plex-sans-400 text-sm md:text-xl mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-6">
          ...
          <Link
            href="mofacertificateattestation"
            className="text-sm md:text-2xl font-ibm-plex-sans-600"
          >
            <Image
              className="mb-1 md:mb-4"
        ...
        <h1 className="text-xl md:text-3xl font-ibm-plex-sans-400 mt-10 md:mt-36 mb-1">
