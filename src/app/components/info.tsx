...
export default function Info() {
    return <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6">
        <div className="p-10 bg-card rounded-3xl">
            <div className="text-32px font-ibm-plex-sans-600">Asif Leghari</div>
            <div className="text-2xl font-ibm-plex-sans-400 mt-1 mb-12">Managing Director | Executive Consultant</div>
            <div className="flex flex-col gap-4">
                <div className="flex flex-row items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-ibm-plex-sans-600">+971 55 796 7733</div>
                    </div>
                </div>
                <div className="flex flex-row items-center gap-4">
                    <span className="material-symbols-outlined text-32px">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-ibm-plex-sans-600">+971 4 266 5806</div>
                    </div>
                </div>
                <div className="flex flex-row items-center gap-4">
                    <span className="material-symbols-outlined text-32px">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-ibm-plex-sans-600">asif@jenandocuments.ae</div>
                    </div>
                </div>
                <div className="flex flex-row items-center gap-4">
                    <span className="material-symbols-outlined text-32px">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-ibm-plex-sans-600">Office No# 44, Al Fahidi St, Dubai UAE</div>
                    </div>
                </div>
                <div className="flex flex-row items-center gap-4">
                    <span className="material-symbols-outlined text-32px">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-ibm-plex-sans-600">www.jenandocuments.ae</div>
                    </div>
                </div>
            </div>
        </div>
        <div className=" bg-card rounded-3xl flex justify-center items-center">
            <iframe
                title="map"
