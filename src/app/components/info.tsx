  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-6">
      <div className="p-6 md:p-10 bg-card rounded-3xl">
        <div className="text-2xl md:text-32px font-ibm-plex-sans-600">
          Asif Leghari
        </div>
        <div className="text-sm md:text-2xl font-ibm-plex-sans-400 mt-1 mb-4 md:mb-12">
        ...
        <div className="flex flex-col gap-3 md:gap-4">
          <div className="flex flex-row items-center gap-4">
            ...
            <div>
              ...
              <div className="md:text-lg font-ibm-plex-sans-600">
                +971 55 796 7733
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-row items-center gap-4">
            ...
            <div>
              ...
              <div className="md:text-lg font-ibm-plex-sans-600">
                Office No# 44, Al Fahidi St, Dubai UAE
              </div>
            </div>
          </div>
          <div className="flex flex-row items-center gap-4">
      ...
      <div className="py-8 px-8 bg-card rounded-3xl">
        ...
        <div className="font-ibm-plex-sans-400 text-sm md:text-base">
          our trusted partner in navigating the intricate landscape of documents
          clearing services and government-related processes. Our mission is to
        ...
        <div className="font-ibm-plex-sans-400 text-sm md:text-base">
          we specialize in a comprehensive range of documents clearing services
          and government-related solutions tailored to meet your unique needs.
          Whether you are an individual, a business entity, or a non-profit
